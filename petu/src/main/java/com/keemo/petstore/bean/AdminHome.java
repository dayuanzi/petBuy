...
// Generated 2015-6-29 14:23:25 by Hibernate Tools 3.4.0.CR1
 ...
 * @see com.keemo.petstore.bean.Admin
	...
	public Admin findById(java.lang.Integer id) {
		...
		try {
			Admin instance = (Admin) sessionFactory.getCurrentSession().get(
					"com.keemo.petstore.bean.Admin", id);
			if (instance == null) {
	...
	public List findByExample(Admin instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.keemo.petstore.bean.Admin")
