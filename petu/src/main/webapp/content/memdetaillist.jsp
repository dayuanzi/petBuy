...
<ss:a href="MemOwnCatsAction?userid=1&pageNumber=1" targets="divCatList" >我的猫舍</ss:a>
<ss:a href="MemOwnCatsAction?userid=1&pageNumber=1" targets="divCatList" >我的购物车</ss:a>
